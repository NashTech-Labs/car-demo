...
public class ShipmentAggregate {
    ...
    public  void on(ShipmentCreatedEvent shipmentCreatedEvent) {
        ...
        this.grandTotal = shipmentCreatedEvent.getGrandTotal();
        this.tax = shipmentCreatedEvent.getTax();
        this.userId = shipmentCreatedEvent.getUserId();
        this.firstName = shipmentCreatedEvent.getFirstName();
        this.lastName = shipmentCreatedEvent.getLastName();
        this.address = shipmentCreatedEvent.getAddress();
